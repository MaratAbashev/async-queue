...
public class ConsumerService(HttpClient httpClient) : IConsumerService
{
    ...
    public async Task<MessageResult<T>?> PollAsync<T>(CancellationToken cancellationToken = default)
    {
        EnsureRegistered();
